...
export default $config({
  ...
  async run() {
    ...
    const SLACK_CLIENT_ID = new sst.Secret("SlackClientId")
    const SLACK_CLIENT_SECRET = new sst.Secret("SlackClientSecret")
    ...
    new sst.aws.Nextjs("KnowXApp", {
      ...
      environment: {
        ...
        SLACK_CLIENT_ID: SLACK_CLIENT_ID.value,
        SLACK_CLIENT_SECRET: SLACK_CLIENT_SECRET.value,
